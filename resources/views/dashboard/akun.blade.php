                            ...
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    @if (Auth::check() && Auth::user()->name === 'DefaultAdmin')
                                        ...
                                        <small class="form-text text-muted text-danger" style="font-size: 10px;">This
                                            account cannot be renamed.</small>
                                    @else
                        ...
                        @foreach ($users as $user)
                            <li class="list-group-item d-flex align-items-center flex-wrap">
                                @if ($user->name === 'DefaultAdmin')
                                    <img src="{{ asset('images/defaultadmin.png') }}" alt="Profile Image"
                                        class="rounded-circle mr-3" style="width: 50px; height: 50px;">
                                @elseif(!$user->gambarakun)
                                    <img src="{{ asset('images/defaultakun.jpeg') }}" alt="Profile Image"
                                        class="rounded-circle mr-3" style="width: 50px; height: 50px;">
                                @else
                ...
                <a id="changeAvatar">
                    ...
                    @if (Auth::check())
                        @if (Auth::user()->name === 'DefaultAdmin')
                            <img class="avatar border-gray" src="{{ asset('images/defaultadmin.png') }}"
                                alt="...">
                        @elseif(!Auth::user()->gambarakun)
                            <img class="avatar border-gray" src="{{ asset('images/defaultakun.jpeg') }}"
                                alt="...">
                        @else
