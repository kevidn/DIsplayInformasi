            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-columns">
                        ...
                        <div class="card">
                            <img class="card-img-top" src="{{ asset('/storage/beritas/upload/'.$singleBerita->gambar) }}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">{{ $singleBerita->judul }}</h5>
                                <p class="card-text">{{ $singleBerita->isi }}</p>

                                <form action="{{ route('hapusBerita', $singleBerita->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ route('editberita', ['id' => $singleBerita->id]) }}" class="btn btn-warning">&#9998; Edit Berita</a>
